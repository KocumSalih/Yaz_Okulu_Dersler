<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="DersGuncelle.aspx.cs" Inherits="Yaz_Okulu_Dersler.Ders_Sayfalari.DersGüncelle" %>
        ...
        <form runat="server">
            ...
            <div class="row g-3">
                ...
                <div class="col-md-12 ">
                    ...
                    <asp:TextBox CssClass="form-control" ID="txtDersId" runat="server"></asp:TextBox>
                </div>
            ...
            <div class="col-12">
                <asp:Button CssClass="btn btn-primary my-2" ID="btnDersGuncelle" runat="server" Text="Ders Güncelle" OnClick="btnDersGuncelle_Click" />
            </div>
